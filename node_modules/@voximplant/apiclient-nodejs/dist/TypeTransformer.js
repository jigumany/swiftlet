...
TypeTransformer.fromActors = {
    ...
    'AllocateAlfaBankPaymentResultType': function (data) {
        ...
        if (typeof data['formUrl'] !== 'undefined')
            xData['formUrl'] = TypeTransformer.to('string')(data['formUrl']);
        if (typeof data['payment_id '] !== 'undefined')
            xData['paymentId '] = TypeTransformer.to('string')(data['payment_id ']);
        return xData;
    },
...
TypeTransformer.toActors = {
    ...
    'AllocateAlfaBankPaymentResult': function (data) {
        const xData = {};
        if (typeof data['formUrl'] !== 'undefined')
            xData['formUrl'] = TypeTransformer.from('string')(data['formUrl']);
        if (typeof data['paymentId '] !== 'undefined')
            xData['payment_id '] = TypeTransformer.from('string')(data['paymentId ']);
        return xData;
    },
