...
class VoximplantApiClient {
            ...
            */
            sQ_AddQueue: (request) => {
                const reqMapper = [{ rawName: 'application_id', name: 'applicationId', transformer: TypeTransformer_1.default.to('number') },
                    ...
                    { rawName: 'call_agent_selection', name: 'callAgentSelection', transformer: TypeTransformer_1.default.to('[SQAgentSelectionStrategies]') },
                    { rawName: 'call_task_selection', name: 'callTaskSelection', transformer: TypeTransformer_1.default.to('[SQTaskSelectionStrategies]') },
                    { rawName: 'application_name', name: 'applicationName', transformer: TypeTransformer_1.default.to('string') },
                    { rawName: 'im_agent_selection', name: 'imAgentSelection', transformer: TypeTransformer_1.default.to('[SQAgentSelectionStrategies]') },
                    { rawName: 'im_task_selection', name: 'imTaskSelection', transformer: TypeTransformer_1.default.to('[SQTaskSelectionStrategies]') },
    ...
    makeRequest(request, requestData, transformer) {
        ...
        return axios_1.default.post(`https://${this.host || 'api.voximplant.com'}/platform_api`, form, { headers: Object.assign(Object.assign({}, form.getHeaders()), { 'Authorization': 'Bearer ' + token }) })
            .then(response => {
